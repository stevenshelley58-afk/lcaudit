...
function buildSimulatedPaths(hostname: string): string[] {
  return [
    ...
    `Oh look another one — your links are having a rough day`,
    ...
    `CLS score suggests your layout is doing the macarena`,
    ...
    `Claude is writing a haiku about your bounce rate`,
